...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_DAMAGECOUNTER_LOG, "INSERT INTO dps_counters (year, month, entry, mode, guid, dps) VALUES (YEAR(), MONTH(), ?, ?, ?, ?) ON DUPLICATE KEY UPDATE dps = GREATEST(dps, VALUES(dps))", CONNECTION_ASYNC);
}

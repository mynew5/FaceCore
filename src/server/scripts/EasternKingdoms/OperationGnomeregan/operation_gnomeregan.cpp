            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        sLog->outError("scripts", "Unexpected movement variation (%i) in npc_og_suitAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 18:
                        ...
                        break;
                    default:
                        sLog->outError("scripts", "Unexpected movement variation (%i) in npc_og_infantryAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        sLog->outError("scripts", "Unexpected movement variation (%i) in npc_og_tankAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        sLog->outError("scripts", "Unexpected movement variation (%i) in npc_og_i_tankAI::SetupMovement call!", variation);
                        return;
                }
    ...
    public:
        ...
        struct npc_og_mekkatorqueAI : public npc_escortAI
        {
            ...
            void SpecialKill(uint32 variation)
            {
                switch (variation)
                {
                        ...
                        if (uiStep > 14)
                        {
                            switch (uiRLDestroyed)
                            {
                                ...
                                case 4:
                                    break;
                                //default:
                                    sLog->outError("scripts", "More than 4 Rocket Launchers destroyed!");
                            }
                        }
                        break;
                    case 1:
                        ...
                        if (uiCannonsDestroyed > 6)
                            sLog->outError("scripts", "More than 6 Tankbuster Cannons destroyed!");
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    //default:
                        sLog->outError("scripts", "Unexpected variation (%i) in npc_og_mekkatorqueAI::SpecialKill call!", variation);
                }
            }
            ...
            void DoPlayMusic(uint8 musicId)
            {
                switch (musicId)
                {
                    ...
                    case 2:
                        ...
                        break;
                    //default:
                        sLog->outError("scripts", "Unexpected musicId (%i) in npc_og_mekkatorqueAI::DoPlayMusic call!", musicId);
                }
            }
            ...
            void UpdateBannerState(float radius)
            {
                ...
                //else
                    sLog->outError("scripts", "TSCR error: BannerList is empty!");
            }

...
bool TELE::IsAllowedToTeleport(Player * const player) const
{
    ...
    sLog->outError("sql.sql", "Invalid flag (category: %u). Important problem...", GetCatID());
    return false;
}
                           ...
                           const uint64 &data0, const uint32 &data1)
{
    switch(flag)
    {
      case FLAG_TEAM:
        if (data1)
            sLog->outError("sql.sql", "Invalid data1 (category: %u).", cat);
        if (data0 < MAX_FLAG_TEAM)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (Team) (category: %u).", cat);
        return false;
      ...
      case FLAG_GUILD:
        ...
        if (data0)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (GuildID) (category: %u).", cat);
        return false;
      ...
      case FLAG_GMLEVEL:
        ...
        if (0 < data0 && data0 < 256)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (GmLevel) (category: %u).", cat);
        return false;

      case FLAG_ISGM:
        if (data0)
            sLog->outError("sql.sql", "Invalid data0 (category: %u).", cat);
        if (data1)
            sLog->outError("sql.sql", "Invalid data1 (category: %u).", cat);
        return true;
      ...
      case FLAG_ACCOUNT:
        ...
        if (data0)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (AccountID) (category: %u).", cat);
        return false;
      ...
      case FLAG_LEVEL:
        ...
        if (0 < data0 && data0 < 256)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (Level) (category: %u).", cat);
        return false;

      case FLAG_ITEM:
        if (!data0)
        {
            sLog->outError("sql.sql", "Invalid data0 (ItemID) (category: %u).", cat);
            return false;
        }
        if (data1)
            return true;
        sLog->outError("sql.sql", "Invalid data1 (Item Count) (category: %u).", cat);
        return false;

      case FLAG_QUEST:
        if (!data0)
        {
            sLog->outError("sql.sql", "Invalid data0 (QuestID) (category: %u).", cat);
            return false;
        }
        if (data1 < MAX_QUEST_STATUS + 1)
            return true;
        sLog->outError("sql.sql", "Invalid data1 (Quest Status) (category: %u).", cat);
        return false;
      ...
      case FLAG_GENDER:
        ...
        if (data0 < GENDER_NONE)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (Gender) (category: %u).", cat);
        return false;
      ...
      case FLAG_RACE:
        ...
        if (0 < data0 && data0 < MAX_RACES)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (Race) (category: %u).", cat);
        return false;
      ...
      case FLAG_CLASS:
        ...
        if (0 < data0 && data0 < MAX_CLASSES)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (Class) (category: %u).", cat);
        return false;

      case FLAG_REPUTATION:
        if (!data0)
        {
            sLog->outError("sql.sql", "Invalid data0 (Faction/Reputation) (category: %u).", cat);
            return false;
        }
        if (data1 <= REP_EXALTED)
            return true;
        sLog->outError("sql.sql", "Invalid data1 (Faction/Reputation) (category: %u).", cat);
        return false;
      ...
      case FLAG_PLAYER:
        ...
        if (data0)
            return true;
        sLog->outError("sql.sql", "Invalid data0 (PlayerGuid) (category: %u).", cat);
        return false;
    }

    sLog->outError("sql.sql", "Invalid flag (category: %u).", cat);
    return false;
}
